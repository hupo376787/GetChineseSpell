...
namespace GetChineseSpell
{
    public partial class Form1 : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                if (GetChineseSpell(s).IndexOf(search.ToUpper()) == 0)
                    textBox2.Text += s + "\r\n";
            }
        }
        ...
        private void ReadAllStockFile(string str_stock_file)
        {
            string str_line = "";
        ...
        {
            textBox4.Text = HanziToPinyin.Convert(textBox3.Text);
        }

        private void Form1_Load(object sender, EventArgs e)
        {
            ReadAllStockFile(Application.StartupPath + "\\上海股票.txt");
        ...
        private void comboBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            foreach (string s in LDictionaryName)
            {
                if (GetChineseSpell(s).IndexOf(comboBox1.Text.ToUpper()) == 0)
